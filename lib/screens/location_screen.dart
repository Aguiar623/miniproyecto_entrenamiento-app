...
class _LocationScreenState extends State<LocationScreen> {
  ...
  Future<void> _getCurrentLocation() async {                           // funcion para mostrar ubicacion con sensor gps
    ...
    setState(() {
      _currentPosition = LatLng(position.latitude, position.longitude);  // cuando se obtiene datos se abre el mapa
      _showMap = true;
    });
  }

  Future<void> _saveLocation() async {                  // funcion para guardar la localizacion
  ...
  Future<void> _calculateRoute() async {               // funcion para dibujar la ruta, cargar mapa
