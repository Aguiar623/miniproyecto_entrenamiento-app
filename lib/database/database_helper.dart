...
class DatabaseHelper {
  ...
  Future<Database> get database async {
    ...
    return _database!;                                            // Creacion de base de datos
  }

  Future<Database> _initDB(String filePath) async {               // Inicializar la base de datos
  ...
  // Funcion para guardar la ubicacion de los usuarios por id de usuario
  ...
  // Función para guardar los pasos de los usuarios por id de usuario
  ...
  // funcion para mirar los usuarios registrados
