...
class _StepCounterScreenState extends State<StepCounterScreen> {
  ...
  void initState() {
    ...
    accelerometerEventStream().listen((event) {   // funcion para obtener los pasos con sensor acelerometro
  ...
  // notificacion push para los pasos
